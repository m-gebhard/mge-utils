...
namespace MGeLabs.Utils.Editor
{
    ...
    /// </summary>
    public class BulkObjectReplacer : EditorWindow
    {
        /// <summary>
        /// List of GameObjects to be replaced in the scene.
        /// </summary>
        private readonly List<GameObject> objectsToReplace = new();
        ...
        private void OnGUI()
        {
            EditorGUILayout.LabelField("Bulk Object Replacer", EditorStyles.boldLabel);
            EditorGUILayout.LabelField(
                "Select objects in the scene and click 'Add Selected' to add the objects. " +
                "Choose a replacement prefab and click 'Replace Objects' to perform the replacement.",
